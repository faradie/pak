            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                                <label for="credit" class="col-md-4 col-form-label text-md-right">{{ __('Angka Kredit') }}</label>
    
                                <div class="col-md-6">
                                    <input id="credit" type="credit" class="form-control{{ $errors->has('credit') ? ' is-invalid' : '' }}" name="credit" value="{{ old('credit') }}" required>
