...
<form method="POST" class="daftar" action="{{ route('save_or_submit_fromSaved',$id) }}" enctype="multipart/form-data" >
  ...
  <nav aria-label="breadcrumb">
    ...
    <div class="alert alert-danger" role="alert">
     Berkas Pengajuan Terampil {{ strtoupper($id) }} : No Period
   </div>
   @else
   <div class="alert alert-success" role="alert">
     Berkas Pengajuan Terampil {{ strtoupper($id) }} : Periode {{ \Carbon\Carbon::parse($periods->first()->starts)->format('d/M/Y') ." - ". \Carbon\Carbon::parse($periods->first()->ends)->format('d/M/Y')}}
   </div>
