...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		<li class="breadcrumb-item active" aria-current="page">Berkas Penilaian Akhir</li>
	</ol>
</nav>
	...
	<table id="myTable" class="table table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td align="center">  
					<form action="{{ route('detail_penilaian_final',$penilaian_file->id) }}"><input class="btn btn-info" type="submit" value="Detail" /></form>
				</td>
			</tr>
			@endforeach
		</tbody>
